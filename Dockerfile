...
ARG AGENCYID="1"
ARG AGENCYNAME="TIM"
ARG GTFS_URL="https://drive.google.com/uc?export=download&id=1PWx-QgeFGeza8lwc0qX2RLA1gWAlSnqD"
ARG GTFSRTVEHICLEPOSITIONS="http://45.55.84.20:8082/api/positions"
